...
Binds mining-specific labels and fortune quotes so call sites stay unchanged.
...
FORTUNE_QUOTES = tuple(GENERIC_FORTUNES) + _MINING_FORTUNES

_EGG = _core_easter.AgentEasterEgg(
    label="Basic Materials Analysis",
    sublabel="Junior Mining Research",
    banner_prog="lynx-mining",
    extra_fortunes=_MINING_FORTUNES,
)
