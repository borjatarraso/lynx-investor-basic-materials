...
from lynx_mining.core.storage import get_reports_dir, save_binary, save_json, save_text
from lynx_mining.models import Filing

DOWNLOAD_HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; LynxMining/0.1)", "Accept-Encoding": "gzip, deflate"}
EDGAR_HEADERS = {"User-Agent": "LynxMining/0.1 lynx-mining-research@example.com", "Accept-Encoding": "gzip, deflate"}
