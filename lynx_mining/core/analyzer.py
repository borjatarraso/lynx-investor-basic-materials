"""Main analysis orchestrator for mining companies."""
...
from lynx_mining.core.fetcher import fetch_company_profile, fetch_financial_statements, fetch_info
from lynx_mining.core.news import fetch_all_news
from lynx_mining.core.reports import download_top_filings, fetch_sec_filings
from lynx_mining.core.storage import get_cache_age_hours, has_cache, load_cached_report, save_analysis_report
from lynx_mining.core.ticker import resolve_identifier
from lynx_mining.metrics.calculator import (
    calc_efficiency, calc_growth, calc_intrinsic_value, calc_market_intelligence,
    calc_mining_quality, calc_profitability, calc_share_structure, calc_solvency,
    calc_valuation,
)
from lynx_mining.models import (
    ...
    MiningQualityIndicators, NewsArticle,
...
_ALLOWED_SECTORS = {"basic materials", "energy"}
_ALLOWED_INDUSTRIES = {
    "gold", "silver", "copper", "uranium", "other industrial metals & mining",
...
def run_progressive_analysis(
    ...
    # Validate sector — refuse to analyze non-basic-materials companies
...
def _dict_to_report(d: dict) -> AnalysisReport:
    ...
    return AnalysisReport(
        ...
        mining_quality=_maybe(MiningQualityIndicators, "mining_quality"),
