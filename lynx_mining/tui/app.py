"""Textual UI for Lynx Basic Materials Analysis."""
...
class ExplainModal(ModalScreen):
    ...
    def compose(self) -> ComposeResult:
        from lynx_mining.metrics.explanations import (
...
class ReportView(VerticalScroll):
    ...
    def add_stage(self, stage: str, report: AnalysisReport) -> None:
        ...
        if stage == "profile":
            ...
            self._mount_section("Mining Quality", _build_mining_quality(report))
...
class LynxMiningApp(PagingAppMixin, App):
    TITLE = "Lynx Basic Materials Analysis"
    SUB_TITLE = "Junior Mining & Basic Materials"
    CSS = """
    #search-dialog {
        width: 60;
        height: auto;
    ...
    def on_mount(self) -> None:
        from lynx_mining.tui.themes import register_all_themes, THEME_NAMES
        try:
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        yield Static(
            "[bold blue]  lynx-mining  [/]\n\n"
            "[bold]Basic Materials Analysis Tool[/]\n"
        ...
        if isinstance(focused, DataTable):
            ...
            if section == "conclusion":
                ...
                try:
                    ...
                    for cat in ("valuation", "profitability", "solvency", "growth", "mining_quality"):
    ...
    def action_cycle_theme(self) -> None:
        from lynx_mining.tui.themes import THEME_NAMES
    ...
    def action__ee_lynx(self) -> None:
        from lynx_mining.easter import LYNX_ASCII, WOLF_ASCII, BULL_ASCII
        import random
...
def _build_mining_quality(r: AnalysisReport) -> Static:
    """Build a Rich Table for mining quality with multi-line cell wrapping."""
    m = r.mining_quality
    stage = _get_stage(r)
    tier = _get_tier(r)
    t = RichTable(show_lines=True, border_style="yellow", expand=True)
    ...
    def rel(key: str) -> Relevance:
        return _get_rel(key, tier, "mining_quality", stage)
