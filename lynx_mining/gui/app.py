"""Tkinter graphical user interface for Lynx Basic Materials Analysis."""
...
class SplashScreen:
    ...
    def __init__(self, root: tk.Tk, on_done: callable) -> None:
        ...
        self.subtitle = tk.Label(
            center, text="Basic Materials Analysis", font=FONT_SPLASH_SUB,
            bg=BG, fg=ACCENT,
        )
        ...
        # Version
        from lynx_mining import __version__, __year__, __author__, SUITE_LABEL
...
class LynxMiningGUI:
    """Tkinter GUI application for Lynx Basic Materials Analysis."""
    ...
    def __init__(self, cli_args) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("Lynx Basic Materials Analysis")
    ...
    def _after_splash(self) -> None:
        ...
        from lynx_mining.tui.themes import HOUSE_THEMES as _HOUSE_THEMES
        ...
        try:
            ...
            pass
        self._theme_cycler = ThemeCycler(self.root, start="mining-dark")
    ...
    def _build_toolbar(self) -> None:
        ...
        tk.Label(
            brand, text="Lynx Basic Materials", font=(_FAMILY, 14, "bold"),
    ...
    def _show_themes_menu(self) -> None:
        ...
        sector_family = ["mining-dark", "mining-light"]
    ...
    def _show_controls(self) -> None:
        ...
        self._show_info_popup(
            ...
            "lynx-mining -- Graphical Interface",
            sections,
        )
    ...
    def _ee_shake(self) -> None:
        from lynx_mining.easter import tk_fireworks
        tk_fireworks(self.root)

    def _ee_rainbow(self) -> None:
        from lynx_mining.easter import tk_rainbow_title
        tk_rainbow_title(self.root)

    def _ee_fortune(self) -> None:
        from lynx_mining.easter import FORTUNE_QUOTES
        import random
    ...
    def _run_analysis(self, identifier: str) -> None:
        try:
            ...
            from lynx_mining.core.storage import is_testing
    ...
    def _render_stage(self, stage: str, report: AnalysisReport) -> None:
        ...
        try:
            ...
            elif stage == "mining_quality":
                self._render_mining_quality(report)
    ...
    def _render_sector_industry(self, r: AnalysisReport) -> None:
        from lynx_mining.metrics.sector_insights import get_sector_insight, get_industry_insight
    ...
    def _render_mining_quality(self, r: AnalysisReport) -> None:
        m = r.mining_quality
        if m is None:
            return
        card = CollapsibleCard(
            self.scroll_frame, "Mining Quality Indicators",
            icon=ICON_MINING, accent=YELLOW, expanded=False,
            info_command=lambda: self._show_section_info("mining_quality"),
        )
        self._sections.append(card)
        frame = card.frame
        ...
        stage = r.profile.stage
        tier = _get_tier(r)
        rel = lambda key: get_relevance(key, tier, "mining_quality", stage)
        ...
        rows: list[tuple[str, str, str]] = [
            ...
            ("Geological Quality", _s(m.geological_quality), "geological_quality"),
            ("Resource Grade", _s(m.resource_grade_assessment), "resource_grade_assessment"),
            ("Resource Scale", _s(m.resource_scale_assessment), "resource_scale_assessment"),
    ...
    def _render_screening(self, r: AnalysisReport) -> None:
        """Render the 10-point mining screening checklist."""
    ...
    def _render_conclusion(self, r: AnalysisReport) -> None:
        ...
        # Category scores (using mining_quality instead of moat)
        sep = tk.Frame(frame, bg=BORDER, height=1)
        sep.pack(fill=tk.X, padx=12, pady=6)
        for i, cat in enumerate(("valuation", "profitability", "solvency", "growth", "mining_quality")):
    ...
    def _download_filing_gui(self, filing) -> None:
        ...
        def _do():
            from lynx_mining.core.reports import download_filing
            try:
    ...
    def _show_section_info(self, section_key: str) -> None:
        from lynx_mining.metrics.explanations import get_section_explanation
    ...
    def _show_conclusion_info(self, category: str = "overall") -> None:
        from lynx_mining.metrics.explanations import get_conclusion_explanation
...
def run_gui(args) -> None:
    ...
    app = LynxMiningGUI(cli_args=args)
    app.run()
