"""Interactive prompt-based mode for lynx-mining."""
...
from lynx_mining.core.news import download_article
from lynx_mining.core.reports import download_filing
from lynx_mining.display import display_full_report, display_report_stage
from lynx_mining.models import AnalysisReport

console = Console()

BANNER = "\n[bold blue]  L Y N X   Basic Materials Analysis[/]\n[dim]    Junior Mining & Basic Materials[/]\n"
...
def run_interactive():
    from lynx_mining.core.storage import get_mode, is_testing
    ...
    while True:
        ...
        try:
            console.print(f"\n[bold {prompt_color}]lynx-mining[/] ", end="")
            raw = input().strip()
        ...
        if cmd in ("quit", "exit", "q"):
            ...
            from lynx_mining.metrics.explanations import list_metrics
            ...
            from lynx_mining.core.ticker import search_companies, display_search_results
            ...
            if current_report:
                from lynx_mining.display import _display_mining_quality, _display_share_structure, _display_intrinsic_value, _display_market_intelligence
                _display_mining_quality(current_report); _display_share_structure(current_report)
            ...
            if current_report and current_report.filings:
                from lynx_mining.display import _display_filings; _display_filings(current_report)
            else: console.print("[yellow]No filings available.[/]")
        elif cmd == "news":
            if current_report and current_report.news:
                from lynx_mining.display import _display_news; _display_news(current_report)
            ...
            from lynx_mining.core.storage import list_cached_tickers, get_mode
            ...
            from lynx_mining.core.storage import drop_cache_all, drop_cache_ticker, get_mode
            if arg.lower() == "all":
            ...
            from lynx_mining.metrics.explanations import get_section_explanation, SECTION_EXPLANATIONS
            if not arg:
            ...
            from lynx_mining.metrics.explanations import get_conclusion_explanation, CONCLUSION_METHODOLOGY
            ...
            from lynx_mining.easter import rich_matrix; rich_matrix(console)
        elif cmd == "fortune":
            from lynx_mining.easter import rich_fortune; rich_fortune(console)
        elif cmd == "rocket":
            from lynx_mining.easter import rich_rocket; rich_rocket(console)
        elif cmd == "lynx":
            from lynx_mining.easter import rich_lynx; rich_lynx(console)
        else:
