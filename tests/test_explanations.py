...
class TestGetExplanation:
    ...
    def test_mining_specific_metrics_exist(self):
...
class TestSectionExplanations:
    ...
    def test_mining_quality_section_exists(self):
        sec = get_section_explanation("mining_quality")
        assert sec is not None
        assert "Mining Quality" in sec["title"]
...
class TestConclusionMethodology:
    def test_overall_exists(self):
        ...
        assert "mining quality" in ce["description"].lower()
